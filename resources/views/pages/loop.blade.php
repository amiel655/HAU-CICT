@extends('layouts.app')
 ...
 @section('content')
<div id="loopHeader">
        <span><img src="assets/imgs/logo/loop_logo.png" alt="Loop's Logo" class="img-fluid rounded-circle"></span>
        <h1 class="txt"><br/>LEAGUE OF OUTSTANDING PROGRAMMERS</h1>
			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div>
						...
						<br><br><br>S
						<p class="ptxt">
                            The League Of Outstanding Programmers (LOOP) is the democratic and representative student society of Computer Science students in Holy Angel University.
						</p>
					</div>
				</div>
			</div>
