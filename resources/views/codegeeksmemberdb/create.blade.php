            ...
            <div class="col-md-12 text-center">
                <h1>
                    <span class="white">HAU-</span><span class="orange">CICT</span> | <span class="white">
                        <img src="../assets/imgs/logo/codegeeks_logo.jpg" class="img-fluid rounded-circle" height="50px" width="50px"> ADD MEMBER</span>
                </h1>
            </div>
            <div class="col-md-12"><br><br>
                {!! Form::open(['action' => 'CodeGeeksMemberController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group">
                    ...
                    {{Form::text('title', '', ['class' => 'form-control codegeeks-input codegeeks-focus', 'placeholder' => 'Enter Member Name'])}}
                </div>
                <div class="form-group">
                    <h4>{{Form::label('body', 'POSITION', ['class' => 'white'])}}</h4>
                    {{Form::text('body', '', ['class' => 'form-control codegeeks-input codegeeks-focus', 'placeholder' => 'Enter Member Position'])}}
                </div><br><br>
                <div class="text-right">
                    {{Form::submit('ADD MEMBER', ['class' => 'btn-codegeeks'])}}
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
